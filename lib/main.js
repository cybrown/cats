    ...
    var TreeWatcher = (function () {
        ...
        TreeWatcher.prototype.addDirectory = function (directory) {
            ...
            if (!this.hasDirectory(directory)) {
                ...
                fs.readdirSync(directory).map(function (basename) {
                    return directory + '/' + basename;
                }).forEach(function (filepath) {
                    var s = fs.statSync(filepath);
                    if (s.isDirectory()) {
                        _this.addDirectory(filepath);
                    } else if (s.isFile()) {
...
(function (Cats) {
    ...
    (function (UI) {
        ...
        var TreeView = (function () {
            ...
            TreeView.prototype.findOpenFolders = function (jq, result, prev) {
                var _this = this;
                if (jq == null) {
                ...
                jq.each(function (index, node) {
                    var txt = $(node).children("span").text();
                    result.push(prev + txt);
                    _this.findOpenFolders($(node).children("ul").children(".opened"), result, prev + txt + '/');
                });
                return result;
            };

            TreeView.prototype.refresh = function () {
                console.log(this.findOpenFolders(null, null, null));
